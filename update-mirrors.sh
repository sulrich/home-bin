...
rsync --ignore-existing -avz --delete ftp.rfc-editor.org::ids-text-only/  ~/Dropbox/mirrors/internet-drafts
rsync --ignore-existing -avz --delete ftp.rfc-editor.org::rfcs-text-only/ ~/Dropbox/mirrors/rfc
