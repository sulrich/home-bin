...
rsync --ignore-existing -avz --delete ftp.rfc-editor.org::ids-text-only/  ~/src/mirrors/internet-drafts
rsync --ignore-existing -avz --delete ftp.rfc-editor.org::rfcs-text-only/ ~/src/mirrors/rfc
